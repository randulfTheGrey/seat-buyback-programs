...
Rerun the SeAT plugin permission seeder after installation/upgrade and inspect
the user's roles. Grant each needed permission explicitly; none implies another.
