...
Verified for `1.0.0-rc.1` on 2026-09-12 against current upstream Composer
metadata and SeAT documentation.
...
| Laravel | `^10.48.29` | 10.x | SeAT 5 components require Laravel 10; ADR 0013 raises the patch floor and records EOL risk. |
| Services | `^5.1` | `eveseat/services` 5.1.0 | Provides `AbstractSeatPlugin` and SeAT plugin integration. |
| EVE API models | `^5.0.34` | current 5.0.x | Direct dependency because Buyback reads SeAT-materialized SDE models. |
